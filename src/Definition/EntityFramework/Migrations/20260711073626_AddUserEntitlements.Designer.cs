...
namespace EntityFramework.Migrations
{
    ...
    [Migration("20260711073626_AddUserEntitlements")]
    partial class AddUserEntitlements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.UserCenterMod.UserEntitlement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("EntitlementDefinitionId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<long>("ValueLimit")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("EntitlementDefinitionId");

                    b.HasIndex("UserId");

                    b.HasIndex("UserId", "EntitlementDefinitionId")
                        .IsUnique();

                    b.ToTable("UserEntitlements");
                });

            modelBuilder.Entity("Entity.UserCenterMod.UserEntitlementDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("EntitlementType")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("EntitlementCode")
                        .IsUnique();

                    b.ToTable("UserEntitlementDefinitions");
                });
            ...
            modelBuilder.Entity("Entity.UserCenterMod.UserEntitlement", b =>
                {
                    b.HasOne("Entity.UserCenterMod.UserEntitlementDefinition", "EntitlementDefinition")
                        .WithMany("UserEntitlements")
                        .HasForeignKey("EntitlementDefinitionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
