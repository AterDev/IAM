...
export const I18N_KEYS = {
  ...
  "user": {
    ...
    "createdSuccess": "user.createdSuccess",
    "createFailed": "user.createFailed",
    "loadFailed": "user.loadFailed",
    "updatedSuccess": "user.updatedSuccess",
    "updateFailed": "user.updateFailed",
    "statusLocked": "user.statusLocked",
    "statusUnlocked": "user.statusUnlocked",
    "statusUpdateFailed": "user.statusUpdateFailed",
    "deleteConfirmTitle": "user.deleteConfirmTitle",
    "deleteConfirmMessage": "user.deleteConfirmMessage",
    "deletedSuccess": "user.deletedSuccess",
    "deleteFailed": "user.deleteFailed",
    "selectLock": "user.selectLock",
    "selectUnlock": "user.selectUnlock",
    "batchLocked": "user.batchLocked",
    "batchUnlocked": "user.batchUnlocked",
    "invalidEmail": "user.invalidEmail",
    "passwordMismatch": "user.passwordMismatch"
  },
  "organization": {
    ...
    "createdSuccess": "organization.createdSuccess",
    "createFailed": "organization.createFailed",
    "loadFailed": "organization.loadFailed",
    "updatedSuccess": "organization.updatedSuccess",
    "updateFailed": "organization.updateFailed",
    "deleteWithChildren": "organization.deleteWithChildren",
    "deleteConfirmTitle": "organization.deleteConfirmTitle",
    "deleteConfirmMessage": "organization.deleteConfirmMessage",
    "deletedSuccess": "organization.deletedSuccess",
    "deleteFailed": "organization.deleteFailed",
    "memberLoadFailed": "organization.memberLoadFailed",
    "selectMember": "organization.selectMember",
    "memberAdded": "organization.memberAdded",
    "memberAddFailed": "organization.memberAddFailed",
    "memberRemoved": "organization.memberRemoved",
    "memberRemoveFailed": "organization.memberRemoveFailed",
  ...
  "entitlement": {
    ...
    "saveFailed": "entitlement.saveFailed",
